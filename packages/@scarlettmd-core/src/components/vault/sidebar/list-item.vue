...
onMounted(() => {
  if (button.value) {
    ...
    const tippyInstance = tippy(button.value, {
      content: div,
      allowHTML: true,
      interactive: true,
    ...
    div.setAttribute("class", "border border-neutral-900 flex flex-col gap-x-1 p-2 bg-neutral-950 rounded w-32");
    ...
    trashButton.setAttribute("class", twMerge(base, "text-red-500"));
