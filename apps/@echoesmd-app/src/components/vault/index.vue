  ...
  <div v-if="synced" class="text-black dark:text-white">
    <echoes-app-header>
      <template #prepend>
        ...
        <div v-if="currentVault?.collaboration" class="flex items-center ml-1">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" :class="currentVault.collaboration.synced ? 'fill-green-500' : 'fill-red-500'" class="size-3.5">
